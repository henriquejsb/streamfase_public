...
class GraphMatrix : public Graph {
 private:
  ...
  //int  **_array_subgraph_neighbours;
  vector<int> *_adjOut;
  vector<int> *_adjIn;
  ...
  //STREAM
  //vector<int> _neighbourhood;
  //vector<int> _exclusiveNeighbourhood;
  //bool * _inNeighbourhood;
  void _removeArrayNeighbours(int a, int b);
  void _insertArrayNeighbours(int a, int b);
  void _printArrayNeighbours(int a);
 ...
 public:
  ...
  void reverseEdge(int a, int b){ _adjM[a][b] = !_adjM[a][b];  } // 
  ...
  //STREAM
  void printGraph();
  Graph * getEdgeNeighbourhood(int a, int b, int depth);
